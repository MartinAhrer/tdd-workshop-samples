...
import at.martinahrer.tdd.samples.domain.OrderPosition
...
class OrderPriceCalculatorServiceImplSpec extends Specification {
    ...
    /**
     * This test does even try to be expressive (using literal values in many places, not using self explaining variables, ..)
     */
